...
const grade = pgTable("grade", {
  ...
  publishedBy: text("publishedBy").notNull().default("user"),
  //TODO Needs adding in E-R diagram
  createdAt: timestamp("created_at").notNull().defaultNow(),
  //TODO  Needs adding in E-R diagram
  updatedBy: text("updated_by").notNull().default("user"),
...
export { and as a, area as b, climb as c, db as d, eq as e, climbRoute as f, grade as g, desc as h, isNull as i, sessions as j, or as o, sector as s, users as u };
//# sourceMappingURL=index3-DdXcqWnY.js.map
