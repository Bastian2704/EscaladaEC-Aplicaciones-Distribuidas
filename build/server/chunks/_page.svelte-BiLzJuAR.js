  ...
  $$renderer.component(($$renderer2) => {
    ...
    for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
      ...
      if (u.status !== "deleted") {
        ...
        $$renderer2.push("<!--[!-->");
        $$renderer2.push(`<form method="POST" class="ml-2 inline"><input type="hidden" name="id"${attr("value", u.id)}/> <button formaction="?/restore" class="border px-2 py-1">Restaurar</button></form>`);
      }
...
//# sourceMappingURL=_page.svelte-BiLzJuAR.js.map
